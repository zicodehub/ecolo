...
const Label = ({ color }) => {
  return (
    <Text
      ...
      anchorY="middle"
    >
       Debutez l'Immersion 404 SCHOOL AR
    </Text>
  );
};
...
const ClassHome = () => {
  const texture = useTexture("panneaux_danger.jpg");
